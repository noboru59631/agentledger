...
export async function handleOrchestration(request, { fetchImpl = fetch, env = process.env, now = Date.now } = {}) {
  ...
  try {
    ...
    return response({ source: 'gemini', model, proposal, policy: 'deterministic' });
