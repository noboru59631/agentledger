...
import { ARC_CHAIN_ID, CONTRACT_ADDRESS, DEMO_PAYMENT_CAP, assertArcChain, assertDistinctRecipient, assertDemoPaymentAmount, buildConfirmationPayload } from './live-policy.mjs';
